...
<div id="container1" style="height: 250px; min-width: 300px"></div>
				...
				(function($){ // encapsulate jQuery
					...
					$(function () {
						...
						$.getJSON('./GetReceiveTimeSeries',	function(data) {
							var names = new Array();
							for (n in data) {
								names.push(n);
							}
...
<div id="container2" style="height: 250px; min-width: 300px"></div>
				<script type="text/javascript">
				(function($){ // encapsulate jQuery
					...
					$(function () {
						...
						$.getJSON('./GetLostOnReceiveTimeSeries',	function(data) {
							var names = new Array();
							for (n in data) {
								names.push(n);
							}
