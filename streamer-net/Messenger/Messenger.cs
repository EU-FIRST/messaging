...
namespace Messaging
{
    public class Messenger
    {
        ...
        HashSet<int> lbSet = new HashSet<int>();
        ...
        public Messenger()
        {
            ...
            BLOCK_ON_SEND = Convert.ToInt32(ConfigurationManager.AppSettings.Get("BLOCK_ON_SEND"));
        ...
        public void sendMessage(String message)
        {
            ...
            if (outgoingMessageQueue.Count < Messenger.MAX_QUEUE_SIZE)
            {
                ...
                {
                    outgoingMessageQueue.EnqueueWait(message);
                }
            }
    ...
    class BlockingQueue<T> : IEnumerable<T>
    {
        ...
        public void EnqueueWait(T item)
        {
            lock (this)
            {
